...
<template>
  <div class="buttons is-right">
    <button class="button is-small is-dark" :class="{'is-success': config.intercept}" @click="toggleIntercept">
      <span class="icon">
        <i class="fa-solid fa-bug"></i>
      </span>
    </button>
    <button class="button is-small is-dark js-modal-trigger" data-target="debugger-config-modal">
      <span class="icon">
        <i class="fa-solid fa-gear"></i>
      </span>
    </button>
    <button class="button is-small is-dark js-modal-trigger" data-target="debugger-info">
      <span class="icon">
    ...
    <div class="modal-content">
      <div class="box">
        ...
        <div class="content">
          ...
          <p>
            <small><i class="fa fa-info-circle"></i> Will intercept only script that has next matches. If no filter
              provided then all scripts will be intercepted</small>
          </p>
          <div class="field has-addons" v-for="(filter, i) in config.scriptFilters">
            <div class="control is-expanded">
              <input :value="filter"
                     @input="event => setFilter(i, event.target.value)"
                     @change="updateConfig"
                     class="input is-small" type="text" placeholder="Script filter">
            </div>
            <div class="control">
          ...
          <div class="field has-addons">
            <button class="button is-primary is-small" @click="addFilter">Add script filter</button>
          </div>
        </div>
      </div>
    </div>
